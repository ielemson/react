...
const Aside = () => {
    ...
    const {logout,user,isLoggedIn,fetchUser} = React.useContext(AuthContext)
    ...
    return (
        ...
        <div>
          <div className="-mx-6 px-6 py-4">
            <Link to="/" title="home">
              <img src="https://tailus.io/sources/blocks/tech-startup/preview/images/logo.svg" className="w-32" alt="tailus logo" />
            </Link>
          </div>
          <div className="mt-8 text-center">
            <img src="images/second_user.webp" alt="" className="w-10 h-10 m-auto rounded-full object-cover lg:w-28 lg:h-28" />
            <h5 className="hidden mt-4 text-xl font-semibold text-gray-600 lg:block">{user.fullname}</h5>
          ...
          <ul className="space-y-2 tracking-wide mt-8">
            ...
            <li>
              <a href="#" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group hover:bg-gradient-to-r from-sky-600 to-cyan-400">
        ...
        <button className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group hover:bg-gradient-to-r from-red-600 to-pink-400">
