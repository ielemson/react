...
const Login = () => {
    ...
    const notify_info = (data) => toast.success(`${data}`);
    return (
        <>
            <Header/>
            <div className="h-full mx-auto lg:w-6/12">
                <div className="m-auto py-12 px-6 sm:p-20 xl:w-10/12">
                    ...
                    <div className="mt-12 grid gap-6 sm:grid-cols-2">
                        <button className="h-12 px-6 border border-blue-100 rounded-lg bg-blue-50 hover:bg-blue-100 focus:bg-blue-100 active:bg-blue-200" onClick={()=>notify_info('in progress')}>
                        ...
                        <button className="h-12 px-6 rounded-lg bg-gray-900 transition hover:bg-gray-800 active:bg-gray-600 focus:bg-gray-700" onClick={()=>notify_info('in progress')}>
